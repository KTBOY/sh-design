...
<div style="display: flex; flex-wrap: wrap; gap: 24px; align-items: flex-start; margin: 16px 0;">
  <div style="flex: 0 1 300px;">
    <img src="/mini-program-demo.webp" alt="珊瑚打码小程序真机演示" style="width: 100%; border-radius: 12px; border: 1px solid var(--vp-c-divider); box-shadow: 0 12px 32px -12px rgba(15,23,42,.25);" />
  </div>
